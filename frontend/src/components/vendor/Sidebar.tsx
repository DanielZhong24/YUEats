...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen bg-white dark:bg-slate-800 border-r dark:border-slate-700 p-6 shadow-sm flex flex-col h-full">
      <div className="mb-8">
        <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Vendor</h2>
        <div className="text-sm text-slate-400 mt-1">Manage your restaurant operations</div>
      </div>
      ...
      <nav className="flex flex-col gap-2 flex-1">
        ...
        >
          <Icon><LayoutDashboard size={20} /></Icon>
          <span>Dashboard</span>
        </Link>
        ...
        <Link 
          ...
          className="group flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 transition-all"
        >
          <Icon><UtensilsCrossed size={20} /></Icon>
          <span>Menu</span>
        </Link>
