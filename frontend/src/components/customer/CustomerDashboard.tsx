...
export default function CustomerDashboard() {
  ...
  return (
    <div className="p-8 max-w-[1400px] mx-auto space-y-12">
      <h2 className="text-3xl font-black text-slate-900">Available for Pickup</h2>
        ...
        {restaurantList.map((rest: any) => (
          ...
          >
            <div className="relative aspect-[16/10] rounded-2xl overflow-hidden mb-4 shadow-sm group-hover:shadow-md transition-all">
              <img 
                src={rest.bannerImgUrl || 'https://images.unsplash.com/photo-1513104890138-7c749659a591'} 
                className="object-cover w-full h-full group-hover:scale-105 transition-transform duration-700"
              />
            </div>
            <h4 className="font-bold text-lg text-slate-900">{rest.restaurantName}</h4>
