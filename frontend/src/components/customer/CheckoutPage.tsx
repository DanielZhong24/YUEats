...
export default function CheckoutPage() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      alert(
        `Successfully placed ${Object.keys(groups).length} separate orders!`,
      )
      clearCart()
  ...
  return (
    <div className="max-w-250 mx-auto p-8 grid grid-cols-1 lg:grid-cols-3 gap-12">
      ...
      <div className="lg:col-span-1">
        <div className="bg-white border border-slate-100 p-8 rounded-4xl shadow-2xl sticky top-24 space-y-6">
