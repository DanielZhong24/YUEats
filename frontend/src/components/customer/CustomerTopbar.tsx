  ...
  return (
    <header className="h-16 bg-white border-b border-slate-100 px-8 flex items-center justify-between sticky top-0 z-50">
      ...
      <div className="flex items-center gap-8">
        <Link to="/customer" className="text-2xl font-black tracking-tighter flex items-center shrink-0">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4 border-l pl-6 border-slate-100">
          ...
          <div className="flex flex-col items-end">
            <span className="text-[10px] uppercase font-black text-slate-400 leading-none">Customer</span>
