...
public class DeliveryCourierSignupTest {
        @Autowired
        ...
        @Test
        void testDeliveryCourierSignup() throws Exception {
                ...
                DeliveryCourier deliveryCourier = (DeliveryCourier) user;

                Assertions.assertEquals(UserRole.COURIER, deliveryCourier.getUserRole());

        }

        @Test
        void testDeliveryCourierFail() throws Exception {
                ...
                mockMvc.perform(post("/couriers").contentType(MediaType.APPLICATION_JSON)
                                ...
                                .andExpect(jsonPath("$.password")
                                                .value("Password must be between 8 and 32 characters, " +
