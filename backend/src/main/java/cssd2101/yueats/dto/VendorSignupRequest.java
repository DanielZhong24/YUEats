...
public record VendorSignupRequest(
        ...
        @NotBlank(groups = NotBlankCheck.class, message = "First name cannot be blank")
        @Size(groups = SizeCheck.class, max=50, message="First name must be 50 characters or less")
        @Pattern(regexp = "^[^0-9]*$", message = "First name cannot contain numbers")
        String firstName,

        @NotBlank(groups = NotBlankCheck.class, message = "Last name cannot be blank")
        ...
        @NotBlank(groups= NotBlankCheck.class, message = "Business name cannot be blank")
        @Size(groups= SizeCheck.class, max=30, message = "Business name must be 30 characters or less")
        String businessName
) {
}
